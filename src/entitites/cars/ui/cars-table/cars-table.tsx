        ...
        <table className="min-w-full text-center text-lg text-gray-500">
            <thead className="min-w-full border-b-4 border-double border-b-gray-400 bg-gray-200 text-xl uppercase text-gray-700 ">
                {table.getHeaderGroups().map((headerGroup) => (
                    <tr
                        key={headerGroup.id}
                        className="min-w-full [&>*:nth-child(1)]:w-[72px] [&>*:nth-child(2)]:w-2/12 [&>*:nth-child(3)]:w-[250px] [&>*:nth-child(4)]:w-[150px] [&>*:nth-child(5)]:w-max [&>*:nth-child(6)]:w-[150px] [&>*:nth-child(7)]:w-max [&>*:nth-child(8)]:w-max"
                    >
            ...
            <tbody className="[&>*:nth-child(even)]:bg-white [&>*:nth-child(odd)]:bg-gray-100">
                {table.getRowModel().rows.map((row) => (
                    <tr key={row.id} className="border-b border-b-gray-400">
